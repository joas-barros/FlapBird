...
IMAGEM_CANO = pygame.transform.scale2x(pygame.image.load(os.path.join('imgs', 'imgs', 'pipe.png')))
IMAGEM_CHAO = pygame.transform.scale2x(pygame.image.load(os.path.join('imgs', 'imgs', 'base.png')))
IMAGEM_BACKGROUND = pygame.transform.scale2x(pygame.image.load(os.path.join('imgs', 'imgs', 'bg.png')))
IMAGENS_PASSARO = [
